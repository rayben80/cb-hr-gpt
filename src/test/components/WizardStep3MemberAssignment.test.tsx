/**
 * WizardStep3MemberAssignment 컴포넌트 테스트
 * 조직 재구성 마법사의 3단계: 멤버 할당 컴포넌트 테스트
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';
import { render, screen, fireEvent, cleanup } from '@testing-library/react';
import { WizardStep3MemberAssignment } from '../../components/organization/wizard/WizardStep3MemberAssignment';
...
describe('WizardStep3MemberAssignment Component', () => {
  ...
  it('기본 UI 요소들이 올바르게 렌더링되어야 한다', () => {
    render(<WizardStep3MemberAssignment {...defaultProps} />);
  ...
  it('멤버가 있을 때 멤버 목록이 표시되어야 한다', () => {
    ...
    render(<WizardStep3MemberAssignment {...defaultProps} unassignedMembers={unassignedMembers} />);
  ...
  it('파트에 멤버가 있을 때 멤버 목록이 표시되어야 한다', () => {
    ...
    render(<WizardStep3MemberAssignment {...defaultProps} newTeams={newTeams} />);
