...
describe('TeamCard Component', () => {
    ...
    const defaultProps = {
        ...
        confirmationActions: {
            ...
            confirm: vi.fn(),
            cancel: vi.fn(),
            state: { isOpen: false, config: null },
        },
        searchTerm: '',
        baseDate: '2024-01-01',
    };
    ...
    it('팀 편집 메뉴 항목이 있어야 한다', () => {
        ...
        const editTeamItem = editItems.find((item) => item.textContent?.includes('팀 정보 수정'));
    ...
    it('팀 삭제 메뉴 항목이 있어야 한다', () => {
        ...
        const deleteTeamItem = deleteItems.find((item) => item.textContent?.includes('팀 삭제'));
    ...
    it('빈 팀이고 검색어가 없을 때도 렌더링되어야 한다', () => {
        ...
        render(<TeamCard {...defaultProps} team={emptyTeam} />);
        expect(screen.getByText('개발팀 (0명)')).toBeInTheDocument();
    });
