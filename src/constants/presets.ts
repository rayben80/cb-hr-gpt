...
export const TEMPLATE_ITEM_PRESETS: Record<string, Omit<EvaluationItem, 'id' | 'scoring'>[]> = {
    '역량 평가': [
        { type: '정성', title: '업무 전문성', weight: 20, details: { description: '담당 업무에 대한 전문 지식과 기술 수준' } },
        { type: '정성', title: '문제 해결 능력', weight: 20, details: { description: '업무 중 발생하는 문제를 분석하고 해결하는 능력' } },
        { type: '정성', title: '협업 및 커뮤니케이션', weight: 20, details: { description: '팀원 및 유관 부서와의 원활한 소통과 협력' } },
        { type: '정성', title: '자기 개발', weight: 20, details: { description: '지속적인 학습과 역량 향상을 위한 노력' } },
        { type: '정성', title: '책임감', weight: 20, details: { description: '맡은 업무에 대한 주인의식과 완수 의지' } },
    ],
    '다면 평가': [
        { type: '정성', title: '리더십/팔로워십', weight: 20, details: { description: '리더로서 팀을 이끌거나 팔로워로서 협력하는 능력' } },
        { type: '정성', title: '팀워크', weight: 20, details: { description: '팀 목표 달성을 위한 협력과 기여도' } },
        { type: '정성', title: '의사소통 능력', weight: 20, details: { description: '명확하고 효과적인 의사 전달 및 경청 능력' } },
        { type: '정성', title: '긍정적 영향력', weight: 20, details: { description: '동료에게 미치는 긍정적인 영향과 동기부여' } },
        { type: '정성', title: '전문성 공유', weight: 20, details: { description: '보유한 지식과 경험을 동료와 나누는 자세' } },
    ],
    '리더십 평가': [
        { type: '정성', title: '비전 제시', weight: 15, details: { description: '명확한 방향과 목표를 설정하고 전달하는 능력' } },
        { type: '정성', title: '팀 관리', weight: 20, details: { description: '팀원 역량 파악 및 적절한 업무 배분' } },
        { type: '정성', title: '코칭 및 육성', weight: 20, details: { description: '팀원의 성장을 위한 피드백과 지원' } },
        ...
        { type: '정성', title: '조직 문화 형성', weight: 15, details: { description: '건강한 조직 문화 조성을 위한 노력' } },
    ],
    '수습 평가': [
        { type: '정성', title: '업무 이해도', weight: 20, details: { description: '담당 업무와 조직에 대한 이해 수준' } },
        { type: '정성', title: '학습 속도', weight: 20, details: { description: '새로운 업무와 지식을 습득하는 속도' } },
        { type: '정성', title: '적응력', weight: 20, details: { description: '새로운 환경과 조직 문화에 적응하는 능력' } },
        { type: '정성', title: '업무 태도', weight: 20, details: { description: '성실성, 적극성, 책임감 등 기본 업무 자세' } },
        { type: '정성', title: '협업 능력', weight: 20, details: { description: '동료 및 선배와의 원활한 소통과 협력' } },
    ],
};
...
export const SCORING_TYPES = [
    ...
    { id: '10point', label: '10점제 (1~10점)', grades: ['10점', '9점', '8점', '7점', '6점', '5점', '4점', '3점', '2점', '1점'] },
...
// 채점 방식별 기본 프리셋
export const SCORING_TYPE_PRESETS: Record<string, Record<string, { grade: string; description: string; score: number }[]>> = {
    '5grade': {
        '정량': [
