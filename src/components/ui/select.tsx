...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex min-h-[44px] w-full items-center justify-between whitespace-nowrap',
            'rounded-xl border border-input bg-background px-4 py-2 text-sm',
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            'min-h-[40px] rounded-lg py-2 pl-3 pr-10 text-sm',
